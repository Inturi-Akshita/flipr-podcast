  ...
  db.collection("users")
    ...
    .then((docs) => {
      if (docs.size > 0) {
        ...
        res.send(
          '<center><h1 style="padding-top: 50px;">LOGIN FAILED</h1> <h1>Enter correct credentials</h1><br><h2>OR</h2><br><h1>If not registered </h1><a href = "http://localhost:3000/register"><h2>Register Here</h2></a></center>'
        );
      }
    });
});
